...
Core language
=============
Generated Mon 02 Jun 2025 03:10:21 UTC
...
|     OK      |       File "<stdin>", line 15, in <module>                          |
|             |       File "<stdin>", line 11, in __init__                          |
|             |     MemoryError: memory allocation failed, allocating 4194272 bytes |
+-------------+---------------------------------------------------------------------+
...
| ::             | ::                                                                                             |
|                |                                                                                                |
|     {'val': 2} |     {'test': <function test at 0x758e90805260>, '__name__': '__main__', '__file__': '<stdin>'} |
+----------------+------------------------------------------------------------------------------------------------+
