...
| ::                                                                                        | ::                                              |
|                                                                                           |                                                 |
|       File "<stdin>", line 8                                                              |     Traceback (most recent call last):          |
|     SyntaxError: assignment expression cannot rebind comprehension iteration variable 'i' |       File "<stdin>", line 8, in <listcomp>     |
