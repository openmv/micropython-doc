...
.. class:: CC3K(spi: SPI, pin_cs: Pin, pin_en: Pin, pin_irq: Pin)
   ...
   .. method:: connect(ssid: str, key: str | None = None, *, security: int = WPA2, bssid: bytes | None = None) -> None
   ...
   .. method:: ifconfig() -> tuple[str, str, str, str, str, str]

      Returns a 7-tuple with (ip, subnet mask, gateway, DNS server, DHCP server,
      MAC address, SSID).

   .. method:: patch_version() -> str

      Return the version of the patch program (firmware) on the CC3000.

   .. method:: patch_program(cmd: str) -> None

      Upload the current firmware to the CC3000.  The argument should be 'pgm'.
