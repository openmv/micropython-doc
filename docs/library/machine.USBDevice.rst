...
.. class:: USBDevice()
   ...
   .. method:: config(desc_dev: bytes, desc_cfg: bytes, desc_strs: list | dict | None = None, open_itf_cb: Callable[..., Any] | None = None, reset_cb: Callable[..., Any] | None = None, control_xfer_cb: Callable[..., Any] | None = None, xfer_cb: Callable[..., Any] | None = None) -> None
   ...
   .. method:: submit_xfer(ep: int, buffer: bytes | bytearray | memoryview, /) -> bool
   ...
   .. method:: stall(ep: int, stall: bool | None = None, /) -> bool
