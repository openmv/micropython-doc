...
.. class:: WM8960(i2c: I2C, sample_rate: int, *, bits: int = 16, swap: int = SWAP_NONE, route: int = ROUTE_PLAYBACK_RECORD, left_input: int = INPUT_MIC3, right_input: int = INPUT_MIC2, sysclk_source: int = SYSCLK_MCLK, mclk_freq: int | None = None, primary: bool = False, adc_sync: int = SYNC_DAC, protocol: int = BUS_I2S, i2c_address: int = WM8960_I2C_ADDR)
   ...
   .. method:: set_left_input(input_source: int) -> None

      Specify the source for the left input.  The input source names are listed above.

   .. method:: set_right_input(input_source: int) -> None

      Specify the source for the right input.  The input source names are listed above.

   .. method:: volume(module: int, volume_l: float | None = None, volume_r: float | None = None) -> tuple[float, float] | None
   ...
   .. method:: mute(module: int, mute: bool, soft: bool = True, ramp: int = wm8960.MUTE_FAST) -> None
   ...
   .. method:: set_data_route(route: int) -> None

      Set the audio data route.  For the parameter value/names, see the table above.

   .. method:: set_module(module: int, active: bool) -> None
   ...
   .. method:: alc_mode(channel: int, mode: int = ALC_MODE) -> None
   ...
   .. method:: alc_gain(target: float = -12, max_gain: float = 30, min_gain: float = -17.25, noise_gate: float = -78) -> None
   ...
   .. method:: alc_time(attack: int = 24, decay: int = 192, hold: int = 0) -> None
   ...
   .. method:: deemphasis(active: bool) -> None
