...
.. class:: CAN(bus: Union[int, str], *args, **kwargs)
   ...
   .. method:: init(mode: int, prescaler: int = 100, *, sjw: int = 1, bs1: int = 6, bs2: int = 8, auto_restart: bool = False, baudrate: int = 0, sample_point: int = 75, num_filter_banks: int = 14, brs_sjw: int = 1, brs_bs1: int = 8, brs_bs2: int = 3, brs_baudrate: int = 0, brs_sample_point: int = 75) -> None
   ...
   .. method:: info(list: Optional[list] = None) -> list
   ...
   .. method:: setfilter(bank: int, mode: int, fifo: int, params: Tuple[int, ...], *, rtr: Optional[Tuple[bool, ...]] = None, extframe: bool = False) -> None
   ...
   .. method:: clearfilter(bank: int, extframe: bool = False) -> None
   ...
   .. method:: any(fifo: int) -> bool

      Return ``True`` if any message waiting on the FIFO, else ``False``.

   .. method:: recv(fifo: int, list: Optional[list] = None, *, timeout: int = 5000) -> list
   ...
   .. method:: send(data: Union[int, bytes, bytearray], id: int, *, timeout: int = 0, rtr: bool = False, extframe: bool = False, fdf: bool = False, brs: bool = False) -> None
